...
public class FeatureExtractor {
    ...
    public static class AA_Filter {
        private double[] coeffs = {
                0.0004053458866948208, -0.0003546488346636961, -0.0010326454536157175, -0.0007239201021445352,
                0.000985676833974638, 0.0026214754213113576, 0.0017092888610681614, -0.002192761072533263,
                -0.005548279535175527, -0.003468434767531596, 0.00429339082433505, 0.010541132158361659,
                0.006426984842157257, -0.007797712227908163, -0.018859920594946736, -0.011389845919915847,
                0.013773972013375402, 0.03346063496397457, 0.020498439048544637, -0.02549353630646937,
                -0.0650051540159417, -0.04321655887292481, 0.06204003135928386, 0.21027666995510091, 0.3180503755355886,
                0.3180503755355886, 0.21027666995510091, 0.06204003135928386, -0.04321655887292481, -0.0650051540159417,
                -0.02549353630646937, 0.020498439048544637, 0.03346063496397457, 0.013773972013375402,
                -0.011389845919915847, -0.018859920594946736, -0.007797712227908163, 0.006426984842157257,
                0.010541132158361659, 0.00429339082433505, -0.003468434767531596, -0.005548279535175527,
                -0.002192761072533263, 0.0017092888610681614, 0.0026214754213113576, 0.000985676833974638,
                -0.0007239201021445352, -0.0010326454536157175, -0.0003546488346636961, 0.0004053458866948208};
    ...
    public double[] extractFeatureVectore(double[] x, double[] y, double[] z) {
        ...
        // after aa filter + downsampling we have 16 samples --> zeropadding for DFT
        double[] features = new double[3 * NDFT];
        ...
        System.arraycopy(y_features, NDFT / 2, features, 0, NDFT / 2);
        System.arraycopy(z_features, NDFT, features, 0, NDFT / 2);
