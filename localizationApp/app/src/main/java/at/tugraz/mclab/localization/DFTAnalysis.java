...
public class DFTAnalysis {
    ...
    private static final int fS = 50; // sampling frequency
    ...
    private void generateWindow(int num_taps) {
        ...
        for (int i = 0; i < window.length; i++) {
            window[i] = 0.5 * (1.0 - Math.cos(2 * Math.PI * i / NSig));
